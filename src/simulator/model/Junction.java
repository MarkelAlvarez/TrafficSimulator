...
public class Junction extends SimulatedObject {
	...
	public int getIndiceVerde() {
		
		return indiceVerde;
	}

	public void setIndiceVerde(int indiceVerde) {
		
		this.indiceVerde = indiceVerde;
	}

	public List<Road> getListaEntrantes() {
		
		return listaEntrantes;
	}

	public void setListaEntrantes(List<Road> listaEntrantes) {
		
		this.listaEntrantes = listaEntrantes;
	}
}